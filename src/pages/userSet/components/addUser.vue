...
const rules: any = {
  ...
  business: [{ required: true, message: '请至少选择一个业务组', trigger: 'blur', type: 'array' }],
  ...
  <div class="add-user">
    ...
    <a-form ref="formRef" :model="formState" :rules="rules" layout="vertical">
      ...
      <a-form-item label="所属角色" name="role" style="width: 35vw;">
        <a-select v-model:value="formState.role" :options="response.roleList" placeholder="请选择所属角色" />
      </a-form-item>
        ...
        <div class="select_app">
          <div class="left">
            <div v-for="(item, index) in response.appList" :key="index" class="business-apps">
              <a-checkbox
                v-model:checked="business_apps_check[index].checkAll"
              ...
              <div
                class="extend"
                @click="business_apps_check[index].expanded = !business_apps_check[index].expanded"
              >
              ...
              <div v-if="business_apps_check[index].expanded" class="inner-apps">
                <a-checkbox
                  ...
                  v-model:checked="business_apps_check[index].checkList[index2]"
